...
export default function Skills() {
  ...
  return (
    <div id="skills" className="py-20 bg-white">
      <h2 className="text-4xl font-bold mb-8 text-center text-black font-cal-sans-regular tracking-wide dark:text-white">Skills</h2>
    ...
    <div className="flex flex-nowrap flex-col gap-8 justify-center items-center ">
      <div className="flex-wrap flex gap-8 justify-center items-center">
        <div className="relative cursor-pointer">
          <div className="flex relative  justify-center gap-3 items-center bg-black px-4 py-2 border-[1px] border-gray-700 border-solid rounded-[5px] shadow-[6px_6px_0px_1px_#CAA6F7] min-w-[135px] md:min-w-[180px]">
            <div>
              <svg
            ...
            <p className="font-grotesk text-white text-sm md:text-base">
              Javascript
            </p>
          </div>
        </div>
...
<linearGradient id="tIPmjNUBt_a5oESFbxjTla_YKKmRFS8Utmm_gr1" x1="22.322" x2="24.979" y1="6.179" y2="39.339" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#33c4a2"></stop><stop offset=".979" stopColor="#16a394"></stop></linearGradient><path fill="url(#tIPmjNUBt_a5oESFbxjTla_YKKmRFS8Utmm_gr1)" d="M44.284,36.035L27.687,1.429c-0.855-1.783-3.337-1.93-4.397-0.26L4.886,30.177	c-0.397,0.625-0.385,1.426,0.029,2.04l9.271,13.738c0.575,0.852,1.634,1.237,2.623,0.953l25.942-7.458	C44.208,39.031,44.939,37.402,44.284,36.035z M40.618,37.279L18.8,43.388c-0.505,0.142-0.98-0.305-0.87-0.818l7.735-36.097	c0.139-0.65,1.023-0.755,1.311-0.157l14.265,29.621C41.489,36.481,41.194,37.118,40.618,37.279z"></path>
      ...
      <div className="flex-wrap flex gap-6 justify-center items-center">
        <div className="relative cursor-pointer">
          <div className="flex relative  justify-center gap-3 items-center bg-black px-4 py-2 border-[1px] border-gray-700 border-solid rounded-[5px] shadow-[6px_6px_0px_1px_#34c07c] min-w-[150px] md:min-w-[180px]">
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
<path fill="#80deea" d="M24,34C11.1,34,1,29.6,1,24c0-5.6,10.1-10,23-10c12.9,0,23,4.4,23,10C47,29.6,36.9,34,24,34z M24,16	c-12.6,0-21,4.1-21,8c0,3.9,8.4,8,21,8s21-4.1,21-8C45,20.1,36.6,16,24,16z"></path><path fill="#80deea" d="M15.1,44.6c-1,0-1.8-0.2-2.6-0.7C7.6,41.1,8.9,30.2,15.3,19l0,0c3-5.2,6.7-9.6,10.3-12.4c3.9-3,7.4-3.9,9.8-2.5	c2.5,1.4,3.4,4.9,2.8,9.8c-0.6,4.6-2.6,10-5.6,15.2c-3,5.2-6.7,9.6-10.3,12.4C19.7,43.5,17.2,44.6,15.1,44.6z M32.9,5.4	c-1.6,0-3.7,0.9-6,2.7c-3.4,2.7-6.9,6.9-9.8,11.9l0,0c-6.3,10.9-6.9,20.3-3.6,22.2c1.7,1,4.5,0.1,7.6-2.3c3.4-2.7,6.9-6.9,9.8-11.9	c2.9-5,4.8-10.1,5.4-14.4c0.5-4-0.1-6.8-1.8-7.8C34,5.6,33.5,5.4,32.9,5.4z"></path><path fill="#80deea" d="M33,44.6c-5,0-12.2-6.1-17.6-15.6C8.9,17.8,7.6,6.9,12.5,4.1l0,0C17.4,1.3,26.2,7.8,32.7,19	c3,5.2,5,10.6,5.6,15.2c0.7,4.9-0.3,8.3-2.8,9.8C34.7,44.4,33.9,44.6,33,44.6z M13.5,5.8c-3.3,1.9-2.7,11.3,3.6,22.2	c6.3,10.9,14.1,16.1,17.4,14.2c1.7-1,2.3-3.8,1.8-7.8c-0.6-4.3-2.5-9.4-5.4-14.4C24.6,9.1,16.8,3.9,13.5,5.8L13.5,5.8z"></path><circle cx="24" cy="24" r="4" fill="#80deea"></circle>
      ...
      <div className="flex-wrap flex gap-6 justify-center items-center">
        <div className="relative cursor-pointer">
          <div className="flex relative  justify-center gap-3 items-center bg-black px-4 py-2 border-[1px] border-gray-700 border-solid rounded-[5px] shadow-[6px_6px_0px_1px_#dcab70] max-w-[150px] min-w-[150px]">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
        ...
        <div className="relative cursor-pointer">
          <div className="flex relative  justify-center gap-3 items-center bg-black px-4 py-2 border-[1px] border-gray-700 border-solid rounded-[5px] shadow-[6px_6px_0px_1px_#dc8070] max-w-[150px] min-w-[150px]">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
